...
<?php $custom_args = array(
	'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . __( 'Write your thoughts', 'redline') . '</label><textarea id="comment" name="comment" cols="90" rows="5" aria-required="true"></textarea></p>',
